...
MortyGroup:
	...
	db 30, STANTLER,   LIGHTSCREEN, REFLECT, BODY_SLAM, PSYCHIC
	db 30, NINETALES,    HYPNOSIS, MIMIC, CURSE, NIGHT_SHADE
	db 30, MAROWACK,     HYPNOSIS, SHADOW_BALL, MEAN_LOOK, DREAM_EATER
...
PryceGroup:
	...
	db 34, JYNX,       LOVELY_KISS, ICE_PUNCH, PSYBEAM
	db 34, DEWGONG,    RECOVER, BODY_SLAM, AURORA_BEAM, SURF
	db 34, DELIBIRD,   DRILL_PECK, PRESENT, BUBBLEBEAM, BLIZZARD
	db 38, SNEASEL,    FURY_SWIPES, BLIZZARD, CROSS_CHOP
	db 34, PILOSWINE,  MAGNITUDE, FURY_ATTACK, BLIZZARD, 
	db -1 ; end
