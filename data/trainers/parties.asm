...
FalknerGroup:
	...
	db  7, SKARMORY,     TACKLE, MUD_SLAP, NO_MOVE, NO_MOVE
	db 18, GOLDUCK,   DOUBLESLAP, MIMIC, ENCORE, METRONOME
	db 18, GRANBULL,   DOUBLESLAP, MIMIC, ENCORE, METRONOME
	db 18, GRANBULL,   DOUBLESLAP, MIMIC, ENCORE, METRONOME
	db 18, GRANBULL,   DOUBLESLAP, MIMIC, ENCORE, METRONOME
...
WhitneyGroup:
	...
	db 22, GRANBULL,   DOUBLESLAP, MIMIC, ENCORE, METRONOME
	db 22, AZUMARILL,   DOUBLESLAP, MIMIC, ENCORE, METRONOME
	db 22, CLEFABLE,   DOUBLESLAP, MIMIC, ENCORE, METRONOME
	db 24, MILTANK,    ROLLOUT, ATTRACT, STOMP, MILK_DRINK
	db -1 ; end

BugsyGroup:
	; BUGSY (1)
	db "BUGSY@", TRAINERTYPE_RANDOM, 3, RANDOMLIST_0
	db -1 ; end

MortyGroup:
	; MORTY (1)
	db "MORTY@", TRAINERTYPE_MOVES
	db 30, STANTLER,   LIGHT_SCREEN, REFLECT, BODY_SLAM, PSYCHIC_M
	db 30, NINETALES,    HYPNOSIS, MIMIC, CURSE, NIGHT_SHADE
	db 30, MAROWAK,     HYPNOSIS, SHADOW_BALL, MEAN_LOOK, DREAM_EATER
	db 30, GENGAR,    SPITE, MEAN_LOOK, MIMIC, NIGHT_SHADE
	db -1 ; end

PryceGroup:
	; PRYCE (1)
	db "PRYCE@", TRAINERTYPE_MOVES
	db 40, JYNX,       LOVELY_KISS, ICE_PUNCH, PSYBEAM
	db 40, DEWGONG,    RECOVER, BODY_SLAM, AURORA_BEAM, SURF
	db 40, DELIBIRD,   DRILL_PECK, PRESENT, BUBBLEBEAM, BLIZZARD
	db 40, SNEASEL,    FURY_SWIPES, BLIZZARD, CROSS_CHOP
	db 40, PILOSWINE,  MAGNITUDE, FURY_ATTACK, BLIZZARD, 
	db -1 ; end
...
RandomPartyLists::
	...
	;BUGSY
    db 6
    db 18, BUTTERFREE, WING_ATTACK, PSYBEAM, MEGA_DRAIN,          $fe
    db 18, BEEDRILL, SLUDGE, PIN_MISSILE, WING_ATTACK, FOCUS_ENERGY,            $fe
    db 18, ARIADOS, SPIDER_WEB, LEECH_LIFE, SLUDGE,    $fe
    db 18, SCYTHER, WING_ATTACK, FURY_ATTACK, CUT,                $fe
    db 18, HERACROSS, HEADBUTT, PIN_MISSILE,      $fe
    db 18, PINSIR, VICEGRIP, SLAM, SCARY_FACE,     $fe
    db -1 ; end
    ...
    db 6
    db 18, BUTTERFREE, WING_ATTACK, PSYBEAM, MEGA_DRAIN,  $fe
    db 18, BEEDRILL, SLUDGE, PIN_MISSILE, WING_ATTACK,    $fe
    db 18, ARIADOS, SPIDER_WEB, LEECH_LIFE, SLUDGE, PSYCHIC_M,    $fe
    db 18, SCYTHER, WING_ATTACK, FURY_ATTACK, CUT,    $fe
    db 18, HERACROSS, HEADBUTT, PIN_MISSILE,      $fe
    db 18, PINSIR, VICEGRIP, SLAM, SCARY_FACE,     $fe
    db -1 ; end
