...
; POKE_BALL
	item_attribute 100, HELD_NONE, 0, CANT_SELECT, BALL, ITEMMENU_PARTY, ITEMMENU_CLOSE	
; GREAT_BALL
	item_attribute 300, HELD_NONE, 0, CANT_SELECT, BALL, ITEMMENU_PARTY, ITEMMENU_CLOSE
; ULTRA_BALL
	item_attribute 600, HELD_NONE, 0, CANT_SELECT, BALL, ITEMMENU_PARTY, ITEMMENU_CLOSE
; MASTER_BALL
	item_attribute 5000, HELD_NONE, 0, CANT_SELECT, BALL, ITEMMENU_PARTY, ITEMMENU_CLOSE
; HEAVY_BALL
	item_attribute 150, HELD_NONE, 0, CANT_SELECT, BALL, ITEMMENU_PARTY, ITEMMENU_CLOSE	
; LEVEL_BALL
	item_attribute 150, HELD_NONE, 0, CANT_SELECT, BALL, ITEMMENU_PARTY, ITEMMENU_CLOSE
; LURE_BALL
	item_attribute 150, HELD_NONE, 0, CANT_SELECT, BALL, ITEMMENU_PARTY, ITEMMENU_CLOSE
